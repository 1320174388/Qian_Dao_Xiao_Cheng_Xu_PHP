...
/**
 *  版权声明 :  地老天荒科技有限公司
 *  文件名称 :  Wx_s_teacherValidate2.php
 *  创 建 者 :  Shi Guang Yu
...
class Wx_s_teacherValidate2 extends Validate
{
    /**
     * 名  称 : $rule
     * 功  能 : 验证规则
    ...
    protected $message  =   [
        ...
        'PeriodNum.number'     => '请正确输入课时数量',
        'PeriodNum.min'        => '请正确输入课时数量',
        'PeriodNum.max'        => '请正确输入课时数量',
    ];
}
